...
def load_langpair_dataset(
    ...
    for k in itertools.count():
        ...
        if split == 'train':
            ...
            ##########Multi-30k###########
            # src_img_features = np.load('/data-bin-2/en-de/train.en-de.en.npy')
            ##############################
            ...
            #############Fashion-MMT############
            # src_img_features = np.load("/Fashion-MMT/train.npy")
            ####################################

        elif split == 'valid':
            ##########Multi-30k###########
            # src_img_features = np.load('/data-bin-2/en-de/valid.en-de.en.npy')
            ##############################
            ...
            #############Fashion-MMT############
            # src_img_features = np.load("/Fashion-MMT/valid.npy")
            ####################################

        else:

            ##########Multi-30k###########
            # src_img_features = np.load('/data-bin-2/en-de/test.en-de.en.npy')
            ##############################

            ##########EMMT################
            src_img_features = np.load('/EMMT/test.npy')
            ##############################

            #############Fashion-MMT############
            # src_img_features = np.load("/Fashion-MMT/test.npy")
            ####################################
